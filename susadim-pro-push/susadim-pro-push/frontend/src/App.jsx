        ...
        {tab === "home" && (
          <div className="grid-main">
            ...
            <div className="side-stack">
              <Card>
                <div className="section-title">
                  <Bell size={18} /> Günlük hatırlatıcı
                </div>

                <div className="soft-box">
                  {notificationReady
                    ? "Bildirimler açık. Gün içinde sana hatırlatma yapacağım 💧"
                    : "Gün içinde su hatırlatması almak için bildirimleri aç."}
                </div>

                <div className="row-actions">
                  <ActionButton onClick={subscribeToPush}>Bildirimleri aç</ActionButton>
                </div>

                <p className="muted preview-note">
                  iPhone kullanıyorsan Safari üzerinden Ana Ekrana Ekle yapıp oradan açman daha iyi olur.
                </p>
              </Card>
              ...
              <Card>
                ...
                <p className="muted">
                  Düzenli su içtikçe uygulama seni daha doğru zamanda hatırlatır.
                </p>
              </Card>
            </div>
          </div>
          ...
          <div className="grid-main design-grid">
            ...
            <Card>
              <div className="field">
                ...
                <input value={cupName} onChange={(e) => setCupName(e.target.value)} placeholder="Benim Bardağım" />
              </div>
              ...
              <div className="soft-box">
                İlk sürümde hazır bardak kombinasyonları var. Sonraki sürümde daha fazla tema ve süsleme eklenebilir.
              </div>
            </Card>
          </div>
        )}
          ...
          <div className="grid-main stats-grid">
                ...
                {weekData.map((item) => {
                  ...
                  return (
                    <div key={item.key} className="bar-col">
                      <motion.div initial={{ height: 0 }} animate={{ height: `${height}%` }} className="bar" />
            ...
            <Card>
              ...
              <div className="list-stack">
                ...
                {todayEntries.slice().reverse().map((item) => (
          ...
          <div className="grid-main settings-grid">
            <Card>
              ...
              <div className="row-item">
                <div>
                  ...
                  <div className="muted">{permissionState === "granted" ? "Açık" : "Kapalı"}</div>
                </div>
            ...
            <Card>
              ...
              <ul className="feature-list">
                <li>Akıllı su takibi</li>
                <li>Şans kurabiyesi mesajları</li>
                <li>Günlük hedef takibi</li>
                <li>Bardak özelleştirme</li>
                <li>Pembe çiçek konfeti kutlaması</li>
                <li>Bildirim desteği</li>
              </ul>
              <div className="soft-box">
                Yayına almadan önce bu sürüm kullanıcı tarafında temiz ve kullanılabilir hale getirildi.
              </div>
            </Card>
          </div>
        )}
